...
public class Test30_for_each_loop {
...
//======for each loop rules==================================================================
	//Rule #1: the object must be only either array or Collection or Iterable type
		...
		String s1 = "hari";
		//for(char ch: s) { } //CE: String does not implement Iterable interface
	...
	//Rule #3: we must declare variable in for () only
		//like in regular for loop, we can not declare variable befor for() and 
	...
	//Rule #4: the for() loop can be used after for() { } body,
	//			it is just local to for(){ } only
